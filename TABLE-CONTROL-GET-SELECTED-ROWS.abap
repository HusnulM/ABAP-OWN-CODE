...
MODULE tc100_change_tc_attr OUTPUT.
  DESCRIBE TABLE lt_mat LINES tc100-lines.
ENDMODULE.
...
*      BREAK-POINT.
      ...
      h_cursor = tc100-top_line + lv_line - 1.
      IF lv_field = 'LS_MAT-MATNR'.
        CLEAR ls_mat.
        READ TABLE  lt_mat INDEX h_cursor INTO ls_mat.

        CLEAR str_msg.
        str_msg = |Material { ls_mat-matnr ALPHA = OUT } - { ls_mat-maktx } Selected|.
...
*  BREAK-POINT.
  READ TABLE lt_mat INTO DATA(ls_check) INDEX tc100-current_line.
ENDMODULE.
